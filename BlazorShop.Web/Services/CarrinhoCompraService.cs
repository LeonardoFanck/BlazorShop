...
public class CarrinhoCompraService : ICarrinhoCompraService
{
    ...
    public event Action<int, decimal> OnCarrinhoCompraChanged;
    ...
    public void RaiseEventOnCarrinhoCompraChanged(int totalQuantidade, decimal totalValor)
    {
        if (OnCarrinhoCompraChanged != null)
        {
            OnCarrinhoCompraChanged.Invoke(totalQuantidade, totalValor);
        }
    }
}
